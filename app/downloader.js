    ...
    do {
        let activitiesResponse = await fetch(`https://video.logi.com/api/accessories/${accessory.accessoryId}/activities`, {
            ...
            body: JSON.stringify({
                ...
                'startActivityId': nextStartActivityId,
                "operator": "<=",
                "limit": 100,
        ...
        activities = activities.concat(activitiesResponse.activities);
        nextStartActivityId = activitiesResponse.nextStartTime;

    } while (nextStartActivityId)
